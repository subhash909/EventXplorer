    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                <div class="col-lg-12">
                    <img class="img-responsive center-block img-rounded" src="img/pro/<%= u.getUpic()%>" style="height:200px;width:300px">
                ...
                %>
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                <a class="btn btn-default pull-right" href="DeleteEvent.jsp?eid=<%= es.getEid()%>"><h4>Delete</h4></a>
