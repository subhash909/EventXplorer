    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                <h1 id="homeHeading">Your Favorite College Events are There</h1>
                <hr>
            ...
            <div class="row no-gutter">
                <div class="col-lg-4 col-sm-6">
                    <a href="DisplayEvents.jsp?event_type=Workshop" class="portfolio-box">
                        <img src="img/eventpic/Workshop.jpg" class="img-responsive" alt="">
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="DisplayEvents.jsp?event_type=Technical" class="portfolio-box">
                        <img src="img/eventpic/Technical.jpg" class="img-responsive" alt="">
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                <div class="project-name">
                                    Technical
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="DisplayEvents.jsp?event_type=Cultural" class="portfolio-box">
                        <img src="img/eventpic/Cultural.jpg" class="img-responsive" alt="">
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                <div class="project-name">
                                    Cultural
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="DisplayEvents.jsp?event_type=Sports" class="portfolio-box">
                        <img src="img/eventpic/Sports.jpg" class="img-responsive" alt="">
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                <div class="project-name">
                                   Sports
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="DisplayEvents.jsp?event_type=Management" class="portfolio-box">
                        <img src="img/eventpic/Management.jpg" class="img-responsive" alt="">
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                <div class="project-name">
                                    Management
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="DisplayEvents.jsp?event_type=Other" class="portfolio-box">
                        <img src="img/eventpic/Other.jpg" class="img-responsive" alt="">
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                <div class="project-name">
                                    Other Events
